...
**[Steve Jobs Catching](https://github.com/Hong3651/Project_Steveddarajabs)**

멀티모달 발표 코칭 시스템&nbsp; `2025.11-12`&nbsp; `팀장`

- Gesture(3D CNN) + Audio(Bi-LSTM) + Text(Solar-pro2)
- Gated Fusion MLP, 1664-dim feature vector
...
**[kWh Power Analysis](https://github.com/Hong3651/kWh_analysis)**

산업 시설 전력 최적화 모델링&nbsp; `2026.01`&nbsp; `개인`

- 철강 공장 15분 단위 전력 데이터 ~35,000행
- LightGBM R2=0.779, 약 16% 에너지 절감
- Streamlit 대시보드 구축
...
**[Steel Plate Defect Prediction](https://github.com/Hong3651/Project_Steelplates)**

선박용 후판 품질 안정화&nbsp; `2025.10`&nbsp; `팀장`

- 도메인 기반 파생변수 설계
- XGBoost Acc 0.997 / F1 0.995
- rolling_temp, hsb, fur_soak_temp
...
**[India Used Car Prediction](https://github.com/Hong3651/Project_Indiausedcar)**

중고차 시장 가격 회귀 모델&nbsp; `2025.10-11`&nbsp; `팀장`

- vehicle_age, km_per_year 파생변수
- GradientBoostingRegressor 채택
- New_Price, vehicle_age 핵심 변수
...
- Fisher-Yates Shuffle 재생 덱
- state.json 기반 재생 위치 복원
- systemd 서비스, 부팅 자동 실행

![RaspberryPi](https://img.shields.io/badge/RaspberryPi-A22846?style=flat-square&logo=raspberrypi&logoColor=fff)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=fff)
...
![footer](https://capsule-render.vercel.app/api?type=waving&color=0:1d3557,30:112240,60:0a192f,100:020c1b&height=200&section=footer)
